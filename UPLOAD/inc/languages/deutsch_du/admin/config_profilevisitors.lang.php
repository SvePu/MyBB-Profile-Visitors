...
$l['setting_profilevisitors_enable_desc'] = 'Wähle JA zum Aktivieren! - Bitte beachte auch die <a href="index.php?module=user-groups">gruppenabhängigen Profil Besucher Einstellungen</a> im "Sonstiges" Tab der Gruppeneinstellungen!';

$l['setting_profilevisitors_canviewown'] = 'Benutzer kann eigene Liste sehen?';
$l['setting_profilevisitors_canviewown_desc'] = 'Wähle JA zum Aktivieren, wenn der Benutzer die eigene Liste sehen kann, auch wenn dieses in seiner Benutzergruppe deaktiviert ist!';
...
$l['setting_profilevisitors_overviewpage_perpage_desc'] = 'Lege die Anzahl der Listeneinträge pro Profilbesucher-Seite fest!';
...
// errors
$l['error_wrong_php_version'] = "Entschuldigung, dieses Plugin ist nicht kompatibel mit der verwendeten PHP-Version - Du benötigst mindestens PHP-Version {1} oder höher!";
